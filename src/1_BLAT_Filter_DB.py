...
with open(BLAT_tab_file, "r") as tabfile:
    ...
    for seq in input_seqs:
        if seq not in contaminated_seqs:
            ...
            output_count += 1  # Increment count for each output sequence
            ...
            contaminat_output_count += 1  # Increment count for each contaminated output sequence
...
print(str(contaminat_output_count) + " reads were aligned to the contaminant database")
